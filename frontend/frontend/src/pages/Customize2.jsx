...
function Customize2() {
  ...
  return (
    <div className={`
       w-full h-[100vh] bg-gradient-to-t
    ...
    <h1 className='text-white mb-[40px] text-[30px] text-center' >
        ...
        <input
          ...
          className='w-full max-w-[600px] h-[60px] outline-none border-2
           ...
           placeholder-gray-300 px-[100px] py-[20px] rounded-full'
          ...
          {assistantName && <button className='min-w-[300px] h-[60px] mt-[30px]
              text-black font-semibold cursor-pointer bg-white rounded-full text-[19px]'
              disabled ={loading}
